...
/**
 * The BlueZ object for the DBus ObjectManager. The ObjectManager tracks what
 * items are being added to a place in a DBus object hierarchy on a given DBus
 * bus.
 * 
...
public interface ObjectManager extends DBusInterface {
	...
	/**
	 * Get all objects managed by where the object manager is in the DBus hierarchy.
	 * 
	 * @return a map, keyed by object paths, value a map of interfaces to properties
	 *         for that interface.
	 */
	...
	public static class InterfacesAdded extends DBusSignal {
		...
		/**
		 * A map of the interfaces added, keyed by interface name. and values of the
		 * current values of properties for the interfaces.
		 */
		...
		/**
		 * Get the DBus object path for the object whose interfaces are being added.
		 * 
		 * @return the path
		 */
		...
		/**
		 * Get the map of the interfaces added, keyed by interface name. and values of
	...
	/**
	 * The DBus signal for objects being removed from an object hierarchy and the
	 * interfaces those objects support.
	 * 
	 * @author Keith M. Hughes
	 */
	public static class InterfacesRemoved extends DBusSignal {
		...
		/**
		 * Get the DBus object path for the object whose interfaces are being removed.
		 * 
